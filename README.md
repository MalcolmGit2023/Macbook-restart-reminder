...
- **scripts/Remind Users To Restart macOS- 7 Days.sh**: Alternative script using Jamf Helper HUD window for restart reminders. I tested the script and it works. This was created by https://github.com/segiovanni
...
- Optionally upload `Remind Users To Restart macOS- 7 Days.sh` as an alternative.
